...
public class ExceptionMessages {
    ...
    public static final String WORKSHOP_EXISTS = "BaseWorkshop of this type already exists in this factory.";
    public static final String WORKSHOP_EXISTS_IN_REPOSITORY = "BaseWorkshop of this type already exists in the repository.";
